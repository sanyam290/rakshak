  ...
  return (
    <div className="grid grid-cols-4 gap-2.5 shrink-0">
      ...
      <button
        ...
        className="text-left bg-slate-900/80 hover:bg-slate-800/90 border border-slate-800/80 hover:border-sky-500/60 rounded-xl px-3 py-2 flex items-center justify-between shadow-lg transition-all duration-200 cursor-pointer hover:scale-[1.02] group"
      >
        <div>
          <p className="text-[10px] text-slate-400 font-medium uppercase tracking-wider group-hover:text-sky-300 transition">{t.totalZones}</p>
          <p className="text-lg font-bold text-slate-100 flex items-center gap-1.5">
            {zones.length}
            <span className="text-[9px] font-normal text-slate-400 group-hover:text-sky-300 underline decoration-slate-600 transition">View all zones</span>
          </p>
        </div>
        <div className="p-1.5 bg-slate-800/80 text-sky-400 rounded-lg border border-slate-700/50 group-hover:border-sky-500/50 transition">
          <MapPin size={16} />
        </div>
      </button>
      ...
      <button
        ...
        className={`text-left border rounded-xl px-3 py-2 flex items-center justify-between shadow-lg transition-all duration-200 cursor-pointer hover:scale-[1.02] group ${
          highRiskCount > 0
      ...
      >
        <div>
          <p className="text-[10px] text-slate-400 font-medium uppercase tracking-wider group-hover:text-amber-300 transition">{t.highRiskZones}</p>
          <p className="text-lg font-bold text-amber-400 flex items-center gap-1.5">
            {highRiskCount}
            <span className="text-[9px] font-normal text-slate-400 group-hover:text-amber-300 underline decoration-slate-600 transition">View critical</span>
          </p>
        </div>
      ...
      >
        <div>
          <p className="text-[10px] text-slate-400 font-medium uppercase tracking-wider group-hover:text-rose-300 transition">{t.blockedRoads}</p>
          <p className="text-lg font-bold text-rose-400 flex items-center gap-1.5">
            {blockedRoadsCount}
            <span className="text-[9px] font-normal text-slate-400 group-hover:text-rose-300 underline decoration-slate-600 transition">Road status</span>
          </p>
        </div>
        <div className={`p-1.5 rounded-lg border transition ${
      ...
      >
        <div>
          <div className="flex items-center gap-1.5">
            <p className="text-[10px] text-slate-300 font-bold uppercase tracking-wider group-hover:text-emerald-300 transition">{t.activeAlerts}</p>
            {unackAlertsCount > 0 && (
              <span className="text-[8px] bg-rose-500 text-white font-bold px-1.5 py-0.2 rounded-full animate-pulse">
                STREAM
              </span>
            )}
          </div>
          <p className="text-lg font-bold text-emerald-400 flex items-center gap-1.5">
            {unackAlertsCount}
            <span className="text-[9px] font-normal text-slate-400 group-hover:text-emerald-300 underline decoration-slate-600 transition">View stream</span>
          </p>
        </div>
        <div className={`p-1.5 rounded-lg border transition ${
